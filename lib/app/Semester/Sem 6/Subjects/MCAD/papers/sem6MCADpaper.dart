...
class sem6Mcadpapers extends StatelessWidget {
  @override
...
class _S2021State extends State<S2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fsem6%2Fmobile%20computing%20and%20application%20devlopment%2Fsolution%2FS2022.pdf?alt=media&token=d5967692-01c4-4bf4-ae2d-8ff13fa6ca80');
...
class _W2021State extends State<W2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fsem6%2Fmobile%20computing%20and%20application%20devlopment%2Fsolution%2FW2022.pdf?alt=media&token=878aeb14-5812-4cb6-a369-319929f3a222');
