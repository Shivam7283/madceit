...
class sem6AD_ITpapers extends StatelessWidget {
  @override
...
class _S2021State extends State<S2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fdiploma_it%2Fsem6%2Fandroid%20application%20devlopment%2Fsolution%2FS2022.pdf?alt=media&token=7de1adc7-41d6-43ee-8c41-8f223a4844e4');
...
class _W2021State extends State<W2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fdiploma_it%2Fsem6%2Fandroid%20application%20devlopment%2Fsolution%2FW2021.pdf?alt=media&token=d81d47f2-5105-4be0-bb69-1443414ba2c8');
