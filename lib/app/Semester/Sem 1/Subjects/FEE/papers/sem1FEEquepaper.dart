...
class sem1FEEquepapers extends StatelessWidget {
  @override
...
class _W2021State extends State<W2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fsem1%2FFundamentasofElectricalandElectronics%2Fqpapers%2FW2022.pdf?alt=media&token=1d97c3b3-bbea-419f-b6be-20231de87b4e');
