...
class sem1EASquepapers extends StatelessWidget {
  @override
...
class _W2021State extends State<W2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fsem1%2FEnviornmentandSustainability%2Fqpaper%2FW2022.pdf?alt=media&token=a038bab8-8bce-464e-afeb-4302d28149fc');
