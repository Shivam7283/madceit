...
class sem1PYquepapers extends StatelessWidget {
  @override
...
class _W2021State extends State<W2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fdiploma_it%2Fsem1%2FIntorductiontoitsystem%2Fqpaper%2FW2022.pdf?alt=media&token=1d13e16d-a929-496e-8d18-bff096354088');
