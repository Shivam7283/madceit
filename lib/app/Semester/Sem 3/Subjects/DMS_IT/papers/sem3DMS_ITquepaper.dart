...
class sem3DMS_ITquepapers extends StatelessWidget {
  @override
...
class _S2021State extends State<S2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fdiploma_it%2Fsem3%2Fdigital%20memory%20system%2Fqpaper%2FS2022.pdf?alt=media&token=068ae066-2d82-4a9b-818a-f079de9f47bf');
...
class _W2021State extends State<W2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fdiploma_it%2Fsem3%2Fdigital%20memory%20system%2Fqpaper%2FW2021.pdf?alt=media&token=fbff9853-3e0e-496b-81c0-8a74753cd861');
