...
class sem3PYpapers extends StatelessWidget {
  @override
...
class _W2021State extends State<W2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fsem3%2FScriptingLanguagePython%2Fsolution%2FW2022.pdf?alt=media&token=86e08325-1881-44a3-8e5c-af196a442da6');
