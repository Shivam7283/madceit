...
class sem3BOSquepapers extends StatelessWidget {
  @override
...
class _W2021State extends State<W2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fsem3%2FBasicOperatingSystem%2Fqpapers%2FW2022.pdf?alt=media&token=fa0c01a4-f0de-41c4-b7ad-9a82945ff506');
