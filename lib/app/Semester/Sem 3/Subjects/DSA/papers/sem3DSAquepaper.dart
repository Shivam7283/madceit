...
class sem3DSAquepapers extends StatelessWidget {
  @override
...
class _W2021State extends State<W2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fsem3%2FDataStructuresandAlgorithms%2Fqpapers%2FW2022.pdf?alt=media&token=4a0cac03-a0f8-43d2-9d1d-63abb8cebf10');
