...
class sem3RDBMSpapers extends StatelessWidget {
  @override
...
class _S2021State extends State<S2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fsem3%2FRelationalDatabaseManagementSystem%2Fsolution%2FS2022.pdf?alt=media&token=86936da6-2e35-4460-8ca1-56a87f99c351');
...
class _W2021State extends State<W2021> {
  ...
  loadDocument() async {
    document = await PDFDocument.fromURL(
        'https://firebasestorage.googleapis.com/v0/b/madceit.appspot.com/o/madgineers%2Fmadceit%2Fsem3%2FRelationalDatabaseManagementSystem%2Fsolution%2FW2022.pdf?alt=media&token=2758103d-3c65-4ecd-b25f-be2e5ddad1b7');
